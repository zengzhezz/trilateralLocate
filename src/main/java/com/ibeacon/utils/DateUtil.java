...
public class DateUtil {
	...
	public static String addSecond(String strDate){
		...
		if(arrStr != null){
			...
			result = arrStr[0]+"_"+StringUtil.addzero(Integer.parseInt(arrStr[1]),2)+"_"+
					StringUtil.addzero(Integer.parseInt(arrStr[2]),2)+"_"+StringUtil.addzero(Integer.parseInt(arrStr[3]),2)+"_"+
					StringUtil.addzero(Integer.parseInt(arrStr[4]),2)+"_"+StringUtil.addzero(Integer.parseInt(arrStr[5]),2);
